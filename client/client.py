...
class WWOnlineClient:
	...
	async def handle_player_status_updated(self, player_status_updated_message):
		...
		elif player_status_updated_message['player_status_field'] == 'equipped_sword':
			player_status.set_player_equipped_sword(player_status_updated_message['player_status_value'])
		else:
			player_status.set_player_status_field(player_status_updated_message['player_status_field'], player_status_updated_message['player_status_value'])
